...
pub(super) fn get_required_privacy_policy<FeeRuleT, NoteRef>(
    ...
    for step in proposal.steps() {
        ...
        let has_transparent_recipient =
            output_in_pool(PoolType::Transparent) || change_in_pool(PoolType::Transparent);
    ...
    // No step revealed anything.
    PrivacyPolicy::FullPrivacy
}

pub(super) enum AddressResolutionError {
    ...
    /// Despite a lax [`PrivacyPolicy`], other factors made it impossible to find a
    /// receiver for a recipient UA.
...
impl From<AddressResolutionError> for ErrorObjectOwned {
    fn from(e: AddressResolutionError) -> Self {
        LegacyCode::InvalidParameter.with_message(match e {
            AddressResolutionError::TransparentRecipientNotAllowed => format!(
                "{} {}",
                fl!("err-privpol-addr-transparent-recipient-not-allowed"),
                fl!(
            ...
            AddressResolutionError::TransparentChangeNotAllowed => format!(
                "{} {}",
                fl!("err-privpol-addr-transparent-change-not-allowed"),
                fl!(
                    "rec-privpol-privacy-weakening",
                    parameter = "privacyPolicy",
                    policy = "AllowRevealedRecipients"
            ...
            AddressResolutionError::RevealingSaplingAmountNotAllowed => format!(
                "{} {}",
                fl!("err-privpol-addr-revealing-sapling-amount-not-allowed"),
                fl!(
                    "rec-privpol-privacy-weakening",
                    parameter = "privacyPolicy",
            ...
            AddressResolutionError::CouldNotResolveReceiver => format!(
                "{} {}",
                fl!("err-privpol-addr-could-not-resolve-receiver"),
                fl!(
                    "rec-privpol-privacy-weakening",
                    parameter = "privacyPolicy",
                    policy = "AllowRevealedAmounts"
            ...
            AddressResolutionError::TransparentReceiverNotAllowed => format!(
                "{} {}",
                fl!("err-privpol-addr-transparent-receiver-not-allowed"),
                fl!(
                    "rec-privpol-privacy-weakening",
                    parameter = "privacyPolicy",
                    policy = "AllowRevealedRecipients"
            ...
            AddressResolutionError::RevealingReceiverAmountsNotAllowed => format!(
                "{} {}",
                fl!("err-privpol-addr-revealing-receiver-amounts-not-allowed"),
                fl!(
                    "rec-privpol-privacy-weakening",
                    parameter = "privacyPolicy",
                    policy = "AllowRevealedAmounts"
